################################################################################
####################### nLTR Counts Plotting
########

################################################### 
###  Neoplasia vs L1 counts
################################################### 
...
# Final Plot
plot <- ggplot(mydata, aes(x = Transformed_L1_Counts, y = NeoplasiaPrevalence)) +
  ...
  ylab("Neoplasia Prevalence")+#&#8201;<span style='font-size:8pt;'>(%)</span>") +
...
ggsave("1_L1_Counts_vs_Neoplasia_N.png", plot, width = 10, height = 8, dpi = 800)
# Save RDS
saveRDS(plot, "1_L1_Counts_vs_Neoplasia_N.rds")

################################################### 
###  Neoplasia vs L1-SINEs counts
################################################### 
...
# Final Plot
plot <- ggplot(mydata, aes(x = Transformed_L1_SINEs_Counts, y = NeoplasiaPrevalence)) +
  ...
  # Axis labels
  xlab("Combined Number of Active L1 and SINEs")+#&#8201;<span style='font-size:8pt;'>(Tukey-Transformed)</span>") +
  ylab("Neoplasia Prevalence")+#&#8201;<span style='font-size:8pt;'>(%)</span>") +
...
ggsave("2_L1_SINEs_Counts_vs_Neoplasia_N.png", plot, width = 10, height = 8, dpi = 800)
# Save RDS
saveRDS(plot, "2_L1_SINEs_Counts_vs_Neoplasia_N.rds")

################################################### 
###  Malignancy vs L1 counts
################################################### 
...
# Final plot
plot <- ggplot(mydata, aes(x = Transformed_L1_Counts, y = MalignancyPrevalence)) +
  ...
  # Axis titles
  xlab("Number of Active L1")+#&#8201;<span style='font-size:8pt;'>(Tukey-Transformed)</span>") +
  ylab("Malignancy Prevalence")+#&#8201;<span style='font-size:8pt;'>(%)</span>") +
...
ggsave("3_L1_Counts_vs_Malignancy_N.png", plot, width = 10, height = 8, dpi = 800)
# Save RDS
saveRDS(plot, "3_L1_Counts_vs_Malignancy_N.rds")


################################################### 
###  Malignancy vs L1-SINEs counts
################################################### 
...
# Final Plot
plot <- ggplot(mydata, aes(x = Transformed_L1_SINEs_Counts, y = MalignancyPrevalence)) +
...
# Save with original file names
ggsave("4_L1_SINEs_Counts_vs_Malignancy_N.png", plot, width = 10, height = 8, dpi = 800)
# Save RDS
saveRDS(plot, "4_L1_SINEs_Counts_vs_Malignancy_N.rds")
