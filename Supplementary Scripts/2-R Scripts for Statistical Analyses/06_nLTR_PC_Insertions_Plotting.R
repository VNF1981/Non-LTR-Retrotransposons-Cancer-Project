################################################################################
####################### Plotting nLTR Insertions within PC Genes 
########

################################################### 
###  Neoplasia vs L1 Insertions within PC Genes
################################################### 
...
# Final Plot
plot <- ggplot(mydata, aes(x = Transformed_L1_PC_Intersections, y = NeoplasiaPrevalence)) +
  ...
  # Axis labels
  xlab("Number of L1 Insertions within PC Genes")+
...
#Save PNG
ggsave("9_L1_PC_Insertions_vs_Neoplasia_N.png", plot, width = 10, height = 8, dpi = 800)
# Command to save a ggplot as an R object:
saveRDS(plot, "9_L1_PC_Insertions_vs_Neoplasia_N.rds")

###################################################### 
###  Neoplasia vs L1-SINEs Insertions within PC Genes
###################################################### 
...
# Final Plot
plot <- ggplot(mydata, aes(x = Transformed_L1_SINEs_PC_Intersections, y = NeoplasiaPrevalence)) +
  ...
  # Axis labels
  xlab("Number of L1 and SINE Insertions within PC Genes")+
  ylab("Neoplasia Prevalence")+
...
# Save PNG
ggsave("10_L1_SINEs_PC_Insertions_vs_Neoplasia_N.png", plot, width = 10, height = 8, dpi = 800)
# Command to save a ggplot as an R object:
saveRDS(plot, "10_L1_SINEs_PC_Insertions_vs_Neoplasia_N.rds")

################################################### 
###  Malignancy vs L1 Insertions within PC Genes
################################################### 
...
# Final plot
plot <- ggplot(mydata, aes(x = Transformed_L1_PC_Intersections, y = MalignancyPrevalence)) +
...
ggsave("11_L1_PC_Insertions_vs_Malignancy_N.png", plot, width = 10, height = 8, dpi = 800)
saveRDS(plot, "11_L1_PC_Insertions_vs_Malignancy_N.rds")


####################################################### 
###  Malignancy vs L1-SINEs Insertions within PC Genes
####################################################### 
...
# Final Plot
plot <- ggplot(mydata, aes(x = Transformed_L1_SINEs_PC_Intersections, y = MalignancyPrevalence)) +
...
# Save with original file names
ggsave("12_L1_PC_Insertions_vs_Malignancy_N.png", plot, width = 10, height = 8, dpi = 800)
saveRDS(plot, "12_L1_PC_Insertions_vs_Malignancy_N.rds")
