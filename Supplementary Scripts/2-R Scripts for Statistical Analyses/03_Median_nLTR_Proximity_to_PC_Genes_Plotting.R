################################################################################
####################### Plotting Median Proximity of nLTRs to "PC genes" 

########

################################################### 
###  Neoplasia vs Median L1 Proximity
################################################### 
...
# Final Plot
plot <- ggplot(mydata, aes(x = Transformed_L1_Medians_to_PC_Genes, y = NeoplasiaPrevalence)) +
  ...
  # Axis labels
  xlab("Medians Proximity of Active L1s to PC Genes")+
...
# Save PNG
ggsave("5_L1_Medians_vs_Neoplasia_N.png", plot, width = 10, height = 8, dpi = 800)
# Save RDS
saveRDS(plot, "5_L1_Medians_vs_Neoplasia_N.rds")

################################################### 
###  Neoplasia vs Median L1-SINEs Proximity
################################################### 
...
# Final Plot
plot <- ggplot(mydata, aes(x = Transformed_L1_SINEs_Medians_to_PC_Genes, y = NeoplasiaPrevalence)) +
  ...
  # Axis labels
  xlab("Medians Proximity of Active L1 and SINEs to PC Genes")+
  ylab("Neoplasia Prevalence")+
...
# Save PNG
ggsave("6_L1_SINEs_Medians_vs_Neoplasia.png", plot, width = 10, height = 8, dpi = 800)
# Command to save a ggplot as an R object:
saveRDS(plot, "6_L1_SINEs_Medians_vs_Neoplasia.rds")

################################################### 
###  Malignancy vs Median L1 Proximity
################################################### 
...
# Final Plot
plot <- ggplot(mydata, aes(x = Transformed_L1_Medians_to_PC_Genes, y = MalignancyPrevalence)) +
...
# Save PNG
ggsave("7_L1_Medians_vs_Malignancy.png", plot, width = 10, height = 8, dpi = 800)
# Save as R object
saveRDS(plot, "7_L1_Medians_vs_Malignancy.rds")

################################################### 
###  Malignancy vs Median L1-SINEs Proximity
################################################### 
...
# Final Plot
plot <- ggplot(mydata, aes(x = Transformed_L1_SINEs_Medians_to_PC_Genes, y = MalignancyPrevalence)) +
...
# Save PNG
ggsave("8_L1_SINEs_Medians_vs_Malignancy.png", plot, width = 10, height = 8, dpi = 800)
# Save as R object
saveRDS(plot, "8_L1_SINEs_Medians_vs_Malignancy.rds")
