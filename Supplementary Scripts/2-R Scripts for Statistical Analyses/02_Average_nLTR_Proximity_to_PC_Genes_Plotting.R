################################################################################
####################### Plotting Average Proximity of nLTRs to PC genes 
########
...
# Final Plot
plot <- ggplot(mydata, aes(x = Transformed_L1_IQR_Means_to_PC_Genes, y = NeoplasiaPrevalence)) +
  ...
  # Axis labels
  xlab("Average Proximity of Active L1s to PC Genes")+
...
# Save PNG
ggsave("5_L1_IQR_Means_vs_Neoplasia_N.png", plot, width = 10, height = 8, dpi = 800)
# Save RDS
saveRDS(plot, "5_L1_IQR_Means_vs_Neoplasia_N.rds")
...
# Final Plot
plot <- ggplot(mydata, aes(x = Transformed_L1_SINEs_IQR_Means_to_PC_Genes, y = NeoplasiaPrevalence)) +
  ...
  # Axis labels
  xlab("Average Proximity of Active L1 and SINEs to PC Genes")+
  ylab("Neoplasia Prevalence")+
...
# Save PNG
ggsave("6_L1SINEs_IQR_Mean_vs_Neoplasia_N.png", plot, width = 10, height = 8, dpi = 800)
# Save as R object
saveRDS(plot, "6_L1_SINEs_IQRMean_vs_Neoplasia_N.rds")
...
# Final Plot
plot <- ggplot(mydata, aes(x = Transformed_L1_IQR_Means_to_PC_Genes, y = MalignancyPrevalence)) +
...
# Save PNG
ggsave("7_L1_IQR_Means_vs_Malignancy_N.png", plot, width = 10, height = 8, dpi = 800)
# Save as R object
saveRDS(plot, "7_L1_IQR_Means_vs_Malignancy_N.rds")
...
# Final Plot
plot <- ggplot(mydata, aes(x = Transformed_L1_SINEs_IQR_Means_to_PC_Genes, y = MalignancyPrevalence)) +
...
# Save PNG
ggsave("8_L1_SINEs_IQR_Means_vs_Malignancy_N.png", plot, width = 10, height = 8, dpi = 800)
# Save as R object
saveRDS(plot, "8_L1_SINEs_IQR_Means_vs_Malignancy_N.rds")
