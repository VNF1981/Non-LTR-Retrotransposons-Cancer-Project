...
Each command in the script is explained with detailed comments. The flags used in the [BEDTools](https://bedtools.readthedocs.io/en/latest/content/tools/closest.html) `closest` command are:
